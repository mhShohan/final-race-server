...
const createSchema = z.object({
  ...
  studentWelfare: z
    .number()
    .min(0, { message: 'Student Welfare must be greater than or equal to 0' }),
  ...
  semesterExamFee: z
    .number()
    .min(0, { message: 'Semester Exam Fee must be greater than or equal to 0' }),
  ...
  developmentFee: z
    .number()
    .min(0, { message: 'Development Fee must be greater than or equal to 0' }),
});
...
const updateSchema = z.object({
  ...
  transport: z
    .number()
    .min(0, { message: 'Transport must be greater than or equal to 0' })
    .optional(),
  ...
  treatment: z
    .number()
    .min(0, { message: 'Treatment must be greater than or equal to 0' })
    .optional(),
  roverScout: z
    .number()
    .min(0, { message: 'Rover Scout must be greater than or equal to 0' })
    .optional(),
  BNCC: z.number().min(0, { message: 'BNCC must be greater than or equal to 0' }).optional(),
  computerFee: z
    .number()
    .min(0, { message: 'Computer Fee must be greater than or equal to 0' })
    .optional(),
  semesterExamFee: z
    .number()
    .min(0, { message: 'Semester Exam Fee must be greater than or equal to 0' })
  ...
  admitCard: z
    .number()
    .min(0, { message: 'Admit Card must be greater than or equal to 0' })
    .optional(),
  othersFee: z
    .number()
    .min(0, { message: 'Others Fee must be greater than or equal to 0' })
    .optional(),

  centerFee: z
    .number()
    .min(0, { message: 'Center Fee must be greater than or equal to 0' })
    .optional(),
  association: z
    .number()
    .min(0, { message: 'Association must be greater than or equal to 0' })
    .optional(),
  developmentFee: z
    .number()
    .min(0, { message: 'Development Fee must be greater than or equal to 0' })
