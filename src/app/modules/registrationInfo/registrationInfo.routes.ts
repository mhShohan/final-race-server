...
registrationInfoRoutes.post('/', validateRequest(registrationInfoValidator.createSchema), registrationInfoControllers.create)
registrationInfoRoutes.get('/:id', registrationInfoControllers.getSingle)
registrationInfoRoutes.patch('/:id', validateRequest(registrationInfoValidator.updateSchema), registrationInfoControllers.update)
